...
namespace JR_MVC.Functions
{
    public class APIServiceGoal
    {
        ...
        public static async System.Threading.Tasks.Task<IEnumerable<JR_DB.Goal>> GoalGetList(){
            var response = await GetListMethod("Goal/GetList");
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> GoalSet(JR_DB.Goal object_to_serialize)
        {
            var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
            var response = await SetMethod("Goal/Set", json_);//httpClient.PostAsync(baseurl + "User/Set", content);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
        ...
        public static async System.Threading.Tasks.Task<JR_DB.Goal> GetGoalByID(int id)
        {
            var response = await GetByIDMethod("Goal/GetByID", id);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> GoalEdit(JR_DB.Goal object_to_serialize, int id)
        {
            var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
            var response = await EditMethod("Goal/Edit", id, json_);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                return JsonConvert.DeserializeObject<JR_DB.GeneralResult>(await response.Content.ReadAsStringAsync());
            }
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> GoalDelete(int id)
        {
            //var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
            var response = await DeleteMethod("Goal/Delete", id);//httpClient.PostAsync(baseurl + "Movies/Set", content);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                return JsonConvert.DeserializeObject<JR_DB.GeneralResult>(await response.Content.ReadAsStringAsync());
            }
