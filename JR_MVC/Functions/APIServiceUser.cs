...
namespace JR_MVC.Functions
{
    public class APIServiceUser
    {
        ...
        public static async System.Threading.Tasks.Task<IEnumerable<JR_DB.User>> UserGetList(string accessToken)
        {
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> UserSet(JR_DB.User object_to_serialize, string accessToken)
        {
        ...
        public static async System.Threading.Tasks.Task<JR_DB.User> GetUserByID(int id, string accessToken)
        {
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> UserEdit(JR_DB.User object_to_serialize, int id, string accessToken)
        {
            var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> UserDelete(int id, string accessToken)
        {
            //var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
