...
namespace JR_MVC.Functions
{
    public class APIServiceCategorieBook
    {
        ...
        public static async System.Threading.Tasks.Task<IEnumerable<JR_DB.CategorieBook>> CategorieGetList(){
            var response = await GetListMethod("Categorie/GetList");
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> CategorieSet(JR_MVC.Models.CategorieBook object_to_serialize)
        {
            var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
            var response = await SetMethod("Categorie/Set", json_);//httpClient.PostAsync(baseurl + "User/Set", content);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> CategorieDelete(int id)
        {
            //var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
            var response = await DeleteMethod("Categorie/Delete", id);//httpClient.PostAsync(baseurl + "Movies/Set", content);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                return JsonConvert.DeserializeObject<JR_DB.GeneralResult>(await response.Content.ReadAsStringAsync());
            }
