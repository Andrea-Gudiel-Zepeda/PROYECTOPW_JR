...
{
    public class APIServiceCategorieBook
    {
        ...
        //METODOS DE LA CLASE CATEGORIE BOOK
        public static async System.Threading.Tasks.Task<IEnumerable<JR_DB.CategorieBook>> CategorieGetList(string accessToken){
            var response = await GetListMethod("Categorie/GetList", accessToken);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                return JsonConvert.DeserializeObject<IEnumerable<JR_DB.CategorieBook>>(await response.Content.ReadAsStringAsync());
            }
            else
            {
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> CategorieSet(JR_MVC.Models.CategorieBook object_to_serialize, string accessToken)
        {
            var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
            var response = await SetMethod("Categorie/Set", json_, accessToken);//httpClient.PostAsync(baseurl + "User/Set", content);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
        ...
        public static async System.Threading.Tasks.Task<JR_DB.CategorieBook> GetCategorieByID(int id, string accessToken)
        {
            var response = await GetByIDMethod("Categorie/GetByID", id, accessToken);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> CategorieEdit(JR_DB.CategorieBook object_to_serialize, int id, string accessToken)
        {
            var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
            var response = await EditMethod("Categorie/Edit", id, json_, accessToken);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                return JsonConvert.DeserializeObject<JR_DB.GeneralResult>(await response.Content.ReadAsStringAsync());
            }
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> CategorieDelete(int id, string accessToken)
        {
            //var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
            var response = await DeleteMethod("Categorie/Delete", id, accessToken);//httpClient.PostAsync(baseurl + "Movies/Set", content);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                return JsonConvert.DeserializeObject<JR_DB.GeneralResult>(await response.Content.ReadAsStringAsync());
            }
