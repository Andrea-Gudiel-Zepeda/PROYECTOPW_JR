...
namespace JR_MVC.Functions
{
    public class APIServiceReseña
    {
        ...
        public static async System.Threading.Tasks.Task<IEnumerable<JR_DB.Reseña>> ReseñaGetList(string accessToken)
        {
            var response = await GetListMethod("Reseña/GetList",accessToken);
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> ReseñaSet(JR_DB.Reseña object_to_serialize, string accessToken)
        {
            var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
            var response = await SetMethod("Reseña/Set", json_, accessToken);//httpClient.PostAsync(baseurl + "User/Set", content);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
        ...
        public static async System.Threading.Tasks.Task<JR_DB.Reseña> GetReseñaByID(int id, string accessToken)
        {
            var response = await GetByIDMethod("Reseña/GetByID", id, accessToken);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                return JsonConvert.DeserializeObject<JR_DB.Reseña>(await response.Content.ReadAsStringAsync());
            }
            else
            {
                throw new Exception(response.StatusCode.ToString());
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> ReseñaEdit(JR_DB.Reseña object_to_serialize, int id, string accessToken)
        {
            var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
            var response = await EditMethod("Reseña/Edit", id, json_, accessToken);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                return JsonConvert.DeserializeObject<JR_DB.GeneralResult>(await response.Content.ReadAsStringAsync());
            }
        ...
        public static async System.Threading.Tasks.Task<JR_DB.GeneralResult> ReseñaDelete(int id, string accessToken)
        {
            //var json_ = Newtonsoft.Json.JsonConvert.SerializeObject(object_to_serialize);
            var response = await DeleteMethod("Reseña/Delete", id, accessToken);//httpClient.PostAsync(baseurl + "Movies/Set", content);
            if (response.StatusCode == System.Net.HttpStatusCode.OK)
            {
                return JsonConvert.DeserializeObject<JR_DB.GeneralResult>(await response.Content.ReadAsStringAsync());
            }
